...
public class Main {
    ...
    static void vaccination() {
        ...
        System.out.println("||--------------------------------------------------||");
        try {
            Scanner read = new Scanner(new FileReader("G:\\Practice java\\Covid\\src\\opi\\Vaccination.txt"));
    ...
    static void seeVaccination() {
        ...
        try {
            FileInputStream fis = new FileInputStream("G:\\Practice java\\Covid\\src\\opi\\CovidCase.txt");
    ...
    static void saveFile() {
        for (int i = 0; i < arr.length; i++) {
            if (arr[i].vacc != null && arr[i].hos != null) {
                try {
                    FileOutputStream file = new FileOutputStream("\"G:\\\\Practice java\\\\Covid\\\\src\\\\opi\\\\CovidCase.txt");
